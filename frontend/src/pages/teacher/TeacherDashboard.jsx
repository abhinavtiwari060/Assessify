    ...
    <div className="space-y-6 max-w-7xl mx-auto text-[var(--text-main)]">
      ...
      <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-2xl p-6 shadow-sm space-y-3">
        ...
        <div className="flex flex-wrap gap-3 pt-2">
          ...
          >
            <FileUp className="w-4 h-4 text-[#F59E0B]" /> PDF → MCQ Extractor
          </Link>
          <Link
            to="/teacher/create-essay"
            className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[var(--bg-sub)] hover:bg-[var(--bg-card-hover)] text-[var(--text-main)] border border-[var(--border)] font-bold text-xs transition-colors"
          >
            <FileEdit className="w-4 h-4 text-[#F59E0B]" /> Create Essay Prompt
          </Link>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-[var(--bg-card)] rounded-2xl p-5 border border-[var(--border)] shadow-xs space-y-2">
          ...
          <Link to="/teacher/analytics" className="text-xs font-semibold text-[#F59E0B] hover:underline flex items-center gap-1">
            Question Analytics →
          </Link>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <Link
          to="/teacher/tests"
          className="bg-[var(--bg-card)] rounded-2xl p-5 border border-[var(--border)] shadow-xs hover:border-[#F59E0B]/50 transition-all flex items-center gap-4 group"
        >
          <div className="w-12 h-12 rounded-xl bg-[var(--bg-sub)] border border-[var(--border)] text-[#F59E0B] flex items-center justify-center shrink-0 group-hover:scale-105 transition-transform">
      ...
      <div className="bg-[var(--bg-card)] rounded-2xl border border-[var(--border)] shadow-xs p-5 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Link to="/teacher/tests" className="text-xs font-bold text-[#F59E0B] hover:underline flex items-center gap-1">
            ...
            {recentTests.map((t) => (
              <div key={t._id} className="bg-[var(--bg-sub)] rounded-xl p-4 border border-[var(--border)] space-y-2">
                <div className="flex items-center justify-between text-xs">
                  <span className="font-bold text-[#F59E0B] uppercase">{t.subjectId?.name || 'General'}</span>
